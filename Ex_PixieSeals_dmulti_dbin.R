...
# When the process model uses sequential binomial likelihoods instead of
# a multinomial likelihood, all nodes update with one exception:

# The node Ntot[1], which represents the size argument of
# the multinomial likelihood used in initializing the population model,
# remains stuck at its initial value of 1000. 
# Its parent node cont.Ntot1 is updated, but only within a range that satisfies
# round(cont.Ntot1) = 1000