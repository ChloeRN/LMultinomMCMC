...
# Replacing the multinomial likelihood in the initialization of the population
# model allows node Ntot[1] to update, but all other nodes besides terminal
# time-step nodes (t=6) remain stuck
